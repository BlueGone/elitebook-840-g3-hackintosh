...
KEXT_AIRPORTBRCMFIXUP_URL	=	https://github.com/acidanthera/AirportBrcmFixup/releases/download/2.1.0/AirportBrcmFixup-2.1.0-$(BUILD_TYPE).zip
...
KEXT_APPLEALC_URL	=	https://github.com/acidanthera/AppleALC/releases/download/1.5.3/AppleALC-1.5.3-$(BUILD_TYPE).zip
...
KEXT_LILU_URL	=	https://github.com/acidanthera/Lilu/releases/download/1.4.8/Lilu-1.4.8-$(BUILD_TYPE).zip
...
KEXT_VIRTUALSMC_URL	=	https://github.com/acidanthera/VirtualSMC/releases/download/1.1.7/VirtualSMC-1.1.7-$(BUILD_TYPE).zip
...
KEXT_VOODOOPS2CONTROLLER_URL	=	https://github.com/acidanthera/VoodooPS2/releases/download/2.1.7/VoodooPS2Controller-2.1.7-$(BUILD_TYPE).zip
...
KEXT_WHATEVERGREEN_URL	=	https://github.com/acidanthera/WhateverGreen/releases/download/1.4.3/WhateverGreen-1.4.3-$(BUILD_TYPE).zip
