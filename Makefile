...
KEXT_VOODOOPS2CONTROLLER_VERSION=	2.2.2
...
KEXT_VOODOOPS2CONTROLLER_URL	=	https://github.com/acidanthera/VoodooPS2/releases/download/$(KEXT_VOODOOPS2CONTROLLER_VERSION)/VoodooPS2Controller-$(KEXT_VOODOOPS2CONTROLLER_VERSION)-$(BUILD_TYPE).zip
