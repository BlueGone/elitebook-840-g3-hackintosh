...
OPEN_CORE_VERSION		=	0.7.4

KEXT_AIRPORTBRCMFIXUP_VERSION	=	2.1.3
KEXT_APPLEALC_VERSION		=	1.6.5
KEXT_BRCMPATCHRAM_VERSION	=	2.6.0
KEXT_CPUFRIEND_VERSION		=	1.2.4
KEXT_INTELMAUSI_VERSION		=	1.0.7
KEXT_LILU_VERSION		=	1.5.6
KEXT_RTCMEMORYFIXUP_VERSION	=	1.0.7
KEXT_VIRTUALSMC_VERSION		=	1.2.7
KEXT_VOODOOPS2_VERSION		=	2.2.6
KEXT_WHATEVERGREEN_VERSION	=	1.5.4
