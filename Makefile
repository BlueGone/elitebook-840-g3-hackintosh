...
OPEN_CORE_VERSION		=	0.7.0

KEXT_AIRPORTBRCMFIXUP_VERSION	=	2.1.2
KEXT_APPLEALC_VERSION		=	1.6.1
KEXT_BRCMPATCHRAM_VERSION	=	2.5.9
KEXT_CPUFRIEND_VERSION		=	1.2.3
KEXT_INTELMAUSI_VERSION		=	1.0.6
KEXT_LILU_VERSION		=	1.5.3
KEXT_RTCMEMORYFIXUP_VERSION	=	1.0.7
KEXT_VIRTUALSMC_VERSION		=	1.2.4
KEXT_VOODOOPS2_VERSION		=	2.2.3
KEXT_WHATEVERGREEN_VERSION	=	1.5.0
